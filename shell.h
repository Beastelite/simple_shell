...
/**
 * struct passinfo - info to pass into a function,
 * @arg:  arguements
 ...
 * @linecount_flag: on count thinput
 * @fname:  p filename
 * @env: copy of environ
 ...
 * @status: status of st exec'd command
 * @cmd_buf: address of pointer to cmd_bu
 * @cmd_buf_type: CMD_type
 * @readfd: the fd
 * @histcount: history line num
 */
